...
use egui::{
    epaint, layers::ShapeIdx, Frame, InnerResponse, Response, Sense, Style, Ui, UiBuilder, UiKind,
    UiStackInfo,
};
...
impl ClickableFrame {
    ...
    pub fn begin(self, ui: &mut Ui) -> Prepared {
        ...
        let content_ui = ui.new_child(
            UiBuilder::new()
                .ui_stack_info(UiStackInfo::new(UiKind::Frame).with_frame(self.frame()))
...
impl Prepared {
    ...
    pub fn allocate_space(&self, ui: &mut Ui) -> Response {
        ui.allocate_rect(self.outer_rect(), Sense::click())
    }
